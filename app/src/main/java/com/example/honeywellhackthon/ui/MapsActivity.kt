package com.example.honeywellhackthon.ui
...
import com.example.honeywellhackthon.R
import com.example.honeywellhackthon.network.NetworkService
...
import com.example.honeywellhackthon.utils.AnimationUtils
import com.example.honeywellhackthon.utils.MapUtils
import com.example.honeywellhackthon.utils.PermissionUtils
import com.example.honeywellhackthon.utils.ViewUtils
...
class MapsActivity : AppCompatActivity(), MapsView, OnMapReadyCallback {
    ...
    private var pickUpTextView : AppCompatTextView? = null
    private var dropTextView : AppCompatTextView? = null
    private var requestCabButton : AppCompatButton? = null
    private var statusTextView : AppCompatTextView? = null
    private var nextRideButton : AppCompatButton? = null
    ...
    private fun initViews() {
        ...
        nextRideButton = findViewById(R.id.nextRideButton)
    }
    ...
    private fun launchLocationAutoCompleteActivity(requestCode: Int) {
        Places.initialize(applicationContext, "AIzaSyCBNb3s3AMy0XnaoIygLIMflZlfJ6x1djw");
